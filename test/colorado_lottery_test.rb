...
class ColoradoLotteryTest < Minitest::Test
  ...
  def test_can_register?
    ...
    assert_equal true, @lottery.can_register?(@alexander, @mega_millions)
    ...
    assert_equal true, @lottery.can_register?(@winston, @cash_5)
    assert_equal true, @lottery.can_register?(@winston, @mega_millions)
  end
end
